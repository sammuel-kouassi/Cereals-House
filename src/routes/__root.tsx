...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Cereals House Express is an e-commerce platform for purchasing a variety of cereals online." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Cereals House — Céréales africaines premium" },
      { name: "description", content: "Cereals House Express is an e-commerce platform for purchasing a variety of cereals online." },
      { name: "twitter:description", content: "Cereals House Express is an e-commerce platform for purchasing a variety of cereals online." },
    ],
